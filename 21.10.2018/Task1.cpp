1) Реализуйте структуру Rational для работы с рациональными числами, как с несократимыми дробями. 
  ...
  Для этого добавьте отладочную печать работающую при их использовании. 
  Например, “Copying Constructor is working”.
  Комментарий 3. Последние 2 балла будут ставиться, если перегрузить операторы ввода/вывода. 
